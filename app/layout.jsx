...
export const metadata={metadataBase:new URL(siteUrl),title:{default:title,template:'%s | Berita Auto'},description,icons:{icon:'/favicon.svg',shortcut:'/favicon.svg'},openGraph:{type:'website',siteName:'Berita Auto',locale:'id_ID',title,description},twitter:{card:'summary_large_image',title,description},verification:{google:process.env.GOOGLE_SITE_VERIFICATION||undefined}};
