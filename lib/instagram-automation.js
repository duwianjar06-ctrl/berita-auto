...
export const DEFAULT_AUTO_UPLOAD_INTERVAL_MINUTES=Math.max(1,Math.floor(Number(process.env.INSTAGRAM_AUTO_UPLOAD_INTERVAL_MINUTES||2))||2);
export const INSTAGRAM_NORMAL_PUBLISH_INTERVAL_MS=DEFAULT_AUTO_UPLOAD_INTERVAL_MINUTES*60*1000;
