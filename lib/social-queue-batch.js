...
export const socialQueueBatchDiagnostics={version:2,redisReads:1,redisWrites:2,description:'Concurrent social queue admission uses one MGET, one MSET and one ZADD regardless of article count.'};
