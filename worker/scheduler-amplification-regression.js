...
const getStart=newsRoute.indexOf('export async function GET');const postStart=newsRoute.indexOf('export async function POST');const getBlock=newsRoute.slice(getStart,postStart);const retryIndex=socialRoute.indexOf('delivery.retried>0');const prepareIndex=socialRoute.indexOf('prepareInstagramProductionQueue');const skipIndex=socialRoute.indexOf('qstash_retry_ignored_periodic_job');
