...
{id:'econ-1',title:'Pemerintah Dorong Kepercayaan Aset Emas dan Progres Bank Kliring Renminbi',excerpt:'Pemerintah menugaskan dua lembaga keuangan pengelola Bullion Bank untuk meningkatkan kepercayaan masyarakat dalam menyimpan emas, sementara Bank Indonesia menargetkan Bank Kliring Renminbi beroperasi pada akhir 2026.',category:'Ekonomi',sourceUrl:'https://example.com/emas',sitePublishedAt:'2026-08-22T05:00:00.000Z'}];
...
const economy=buildInstagramSeo(fixtures[3]);assert.equal(economy.primaryKeyword,'Bank Kliring Renminbi');assert.ok(economy.entities.includes('Bank Indonesia'));assert.ok(economy.entities.includes('Bank Kliring Renminbi'));assert.ok(!economy.entities.some(entity=>entity==='Pemerintah Dorong Kepercayaan Aset Emas'));
