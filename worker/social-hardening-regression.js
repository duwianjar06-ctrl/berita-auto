...
const jpeg=await sharp({create:{width:1080,height:1350,channels:3,background:{r:20,g:40,b:70}}}).jpeg({quality:86}).toBuffer();
...
assert.match(route,/X-Social-Card-Render/);assert.match(route,/X-Social-Card-Text-Length/);assert.match(route,/jpeg.length<12\*1024/);
