...
assert.match(route,/@fontsource\\/noto-sans\\/files\\/noto-sans-latin-ext-400-normal\\.woff/);assert.match(route,/@fontsource\\/noto-sans\\/files\\/noto-sans-latin-ext-700-normal\\.woff/);assert.match(route,/source=\\$\\{bundledFontsReady\?'bundled':'fallback'\\}/);
