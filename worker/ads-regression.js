...
import {AD_SLOTS,adAspectRatio,safeTargetUrl,validateImageBytes,validateImageFileMeta,getActiveAd} from '../lib/ads.js';
...
test('invalid protocol is rejected',()=>assert.throws(()=>safeTargetUrl('vbscript:msgbox(1)'),/http|https/));
